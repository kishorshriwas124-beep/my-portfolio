  ...
  return (
    <div ref={containerRef} className="relative w-full h-[300vh] bg-[#F4F3EF]">
      <div className="sticky top-0 w-full h-screen flex flex-col items-center justify-center overflow-hidden px-4 md:px-12 transform-gpu subpixel-antialiased">
        ...
        <div className="relative w-full max-w-[1300px] flex justify-center items-center z-10 mt-10 min-h-[600px]">
          ...
          >
            <div className="relative w-full flex flex-col items-center justify-start">
              <motion.div style={{ opacity: stickerOpacity }} className="absolute -left-6 md:-left-4 top-[-20px] md:top-[-10px] w-14 h-14 md:w-24 md:h-24 select-none">
              ...
              <div className="relative mt-2">
                ...
                <motion.div style={{ opacity: stickerOpacity }} className="absolute -right-10 md:-right-20 bottom-[-15px] md:bottom-[-10px] w-12 h-12 md:w-20 md:h-20 select-none">
        ...
        <motion.div style={{ opacity: headlineOpacity, willChange: "opacity" }} className="absolute bottom-10 left-0 w-full px-6 md:px-16 flex justify-between items-center text-black font-black tracking-tighter select-none pointer-events-none z-40">
        ...
        {/* METRIC STATS */}
        <motion.div style={{ opacity: headlineOpacity, willChange: "opacity" }} className="absolute bottom-28 md:bottom-24 right-6 md:right-16 flex flex-col items-end gap-4 z-40 pointer-events-none">
